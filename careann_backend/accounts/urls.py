...
from .views import RegisterView,UploadCredentialsView,LoginView,ProfileView,CaregiverSearchView,CaregiverDetailView,CaregiverByJobTypeView,CareSeekerDetailView 
